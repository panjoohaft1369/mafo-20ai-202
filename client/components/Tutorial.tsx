    ...
    <section className="mt-16 border-t pt-12 pb-12 px-4 sm:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                برای مثال اگر مبلی می‌فروشید و می‌خواهید آن را با رنگ قرمز نشان
                دهید، بنویسید:
                <br />
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold mb-2">✏️ جزئیات مهم</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                هر چه جزئیات بیشتر باشد، نتیجه بهتر است:
                <br />
                <em className="block mt-2 p-2 bg-muted rounded">
                  "مبل گلبهی روشن، طرح‌ مدرن، بافت فرفری، در اتاق مدرن با فرش
                  خاکستری"
                </em>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ابتدا تصویر اتاق یا محصول را بارگذاری کنید، سپس توضیح دهید چه
                تغییری می‌خواهید:
                <br />
                <em className="block mt-2 p-2 bg-muted rounded">
