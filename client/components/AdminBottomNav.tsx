...
export function AdminBottomNav({
  ...
  return (
    <div className="fixed left-0 right-0 z-40 w-full border-t border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 rounded-t-2xl shadow-2xl bottom-[37px] lg:bottom-0 pb-[37px] lg:pb-8">
