        ...
        {!auth.isLoggedIn && (
          <section className="px-4 py-20 bg-primary/5 border-y border-primary/10">
            <div className="container mx-auto max-w-4xl text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                با استفاده از MAFO، شما از یک تیم ایرانی را حمایت می‌کنید که بر خلاف فشارها و تحریم‌ها، خدمات جهان‌سطح ارائه می‌دهند.
                <br />
                <br />
                <strong>ما را با دوستان و همکاران خود به اشتراک بگذارید</strong> تا بیشتر مردم بتوانند از خدمات اصیل و قابل‌اعتماد ایرانی بهره‌برداری کنند.
              </p>
            </div>
          </section>
        )}
