      ...
      <main className="flex-1 pt-20 md:pt-28">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  icon: "🔗",
                  title: "استقلال",
                  desc: "عدم وابستگی به افراد خارج از مجموعه برای راهنمایی و پشتیبانی",
                },
              ].map((item, idx) => (
                <Card key={idx}>
                  <CardHeader>
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  icon: Zap,
                  title: "سرعت بالا",
                  desc: "طی 1 الی 2 دقیقه تصویری آماده کنید که مشتری متقاعد به خرید از شما شود.",
                },
                {
                  icon: Award,
                  title: "کیفیت حرفه‌ای",
                ...
                },
                {
                  ...
                  desc: "در صورت تمایل یا نیاز، محصول رو در محیط واقعی مشتری نمایش بدید تا اعتماد و حس نیازش به محصول شما افزایش پیدا کنه",
                },
                {
                  icon: Users,
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {[
                ...
                },
                {
                  ...
                  desc: "سیستم سخت‌افزاری مجهز به جدیدترین و قدرتمندترین کارت‌های گرافیکی (GPU) برای پردازش سریع و تولید تصاویر با کیفیت بالا.",
                },
                {
                  icon: Gauge,
                  title: "بروزرسانی مداوم",
                  desc: "تمام‌وقت در حال بهبود و بروزرسانی الگوریتم‌ها و مدل‌های هوش مصنوعی هستیم. اطلاعات و توانایی‌های سیستم همیشه به روزترین هستند.",
                },
              ].map((item, idx) => {
                const Icon = item.icon;
                return (
        ...
        <section className="px-4 py-16 sm:py-20 bg-gradient-to-b from-blue-50 to-background border-b">
          <div className="container mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold mb-6 text-black">📲 نصب اپلیکیشن MAFO</h2>
