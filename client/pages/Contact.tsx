          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-4">
              ...
              <Card>
                ...
                <CardContent className="text-muted-foreground">
                  MAFO از جدیدترین مدل‌های هوش مصنوعی بوده و از GPU‌های قدرتمند
                  استفاده می‌کند تا بالاترین کیفیت تصاویر و ویدیوها را تولید کند
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="text-muted-foreground">
                  <p>
                    حریم خصوصی شما برای ما بسیار اهمیت دارد. تمام اطلاعات و
                    تصاویری که برای ویرایش اپلود میکنید، کاملاً محفوظ و رمزگذاری
                    شده است و کسی جز خودتان دسترسی ندارد. ما متعهد هستیم که
                    تصویر محصول شما به رقبای شما نرسد.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="px-4 py-16 sm:py-20">
          <div className="container mx-auto max-w-4xl text-center bg-primary/5 rounded-2xl p-8 sm:p-12 border border-primary/20">
            ...
            <p className="text-muted-foreground mb-8">
              ...
              آشنایی با پکیج‌های اختصاصی و تعرفه‌های ما، با تیم پشتیبانی ما تماس
              بگیرید. ما آماده‌ایم نیازهای خاص شما را درک کنیم و بهترین راه‌حل
              را پیشنهاد کنیم.
            </p>
