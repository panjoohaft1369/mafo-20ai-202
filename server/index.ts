...
import { handleGetConfig, handleSetupConfigure } from "./routes/setup.js";
...
export function createServer() {
  ...
  // Setup routes
  app.get("/api/setup/config", handleGetConfig);
  app.post("/api/setup/configure", handleSetupConfigure);
