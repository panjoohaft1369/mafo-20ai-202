  ...
  try {
    ...
    if (user.status !== "approved") {
      ...
      res.status(403).json({
        success: false,
        error:
          "حساب کاربری شما هنوز فعال نشده است.\n\nبرای فعال کردن حساب:\n1️⃣ با تیم پشتیبانی ما تماس بگیرید\n☎ 09357887572 | 💬 واتساپ\n\n2️⃣ با آنها در مورد پلان‌های مختلف صحبت کنید\n\n3️⃣ پلان مورد نیاز خود را انتخاب کنید\n\n4️⃣ تیم پشتیبانی حساب شما را فعال می‌کند",
      });
      return;
    }
